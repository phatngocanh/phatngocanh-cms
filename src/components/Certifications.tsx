...
const Certifications = () => {
    ...
    const certifications = [
        ...
        {
            id: 4,
            name: "Thuốc Diệt Mối Tận Gốc ZIFAT 999",
            description: "Chứng nhận hiệu quả diệt mối",
            details: "Sản phẩm thuốc diệt mối ZIFAT 999 được chứng nhận hiệu quả diệt mối tận gốc, an toàn sử dụng",
            year: "2020",
            color: "orange",
            image: "/certificates/termite-killer.jpg"
        },
        {
            id: 5,
            name: "Chất Chống Thấm ZIFAT 999",
            description: "Chứng nhận chất lượng chống thấm",
            details: "Sản phẩm chất chống thấm ZIFAT 999 đạt tiêu chuẩn chống thấm hiệu quả, bền lâu",
            year: "2020",
            color: "yellow",
            image: "/certificates/waterproof.jpg"
        },
        {
            id: 6,
            name: "Thương Hiệu ZIFAT 999",
            description: "Giấy chứng nhận đăng ký nhãn hiệu",
            details: "Thương hiệu ZIFAT 999 đã được đăng ký bảo hộ tại Cục Sở hữu Trí tuệ Việt Nam",
            year: "2020",
            color: "red",
